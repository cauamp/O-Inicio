//Desenvolvedor: Pedro Guilherme Andrade Salgado
//Turma: 205     N.matricula: 2020951627  Data: 22/09/2021
...
void exercicio24()
{
	int cateto1, cateto2, hipo, absx1, absx2, absx3;
	...
	absx1 = (abs(cateto2 - hipo));
	absx2 = (abs(cateto1 - hipo));
	absx3 = (abs(cateto1 - cateto2));
	...
	else if ((absx1 < cateto1 < (cateto2 + hipo)) && (absx2 < cateto2 < (cateto1 + hipo)) && (absx3 < hipo < (cateto1 + cateto2)))
	{
