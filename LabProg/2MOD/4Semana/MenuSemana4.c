...
float retornaSomatorioDoExercicio90(int n, int m)
{
...
*/
    ...
    //srand((unsigned)time(&t)); //funcao time() recebe o endereco de t
    /* 
    a linha acima foi comentada, pois, outro srand já foi definido no main, garantindo o funcionamento de todos exercicios
*/
    printf("\n\n\n");
...
void exercicio82()
{
    ...
    *(ptr+1) =...9
    ...
    (b) E se acrescentarmos as tres linhas abaixo, o que sera impresso?
    ...
    Creio que em *(ptr) sera impresso 5 (o valor da primeira casa de ptr), ja em *(ptr+2) sera impresso 11 (o valor da terceira casa de ptr)


    Valores impressos, apos adicionar as tres linhas:
    *(ptr)     =... 5
    *(ptr + 2) =... 11
*/
}
...
void secao10()
{
    ...
    printf("O pdf com as respostas das secao 10 foi entregue via classroom\n\n");
    printf("Voltando ao menu de secoes!");
}
...
int main(int argc, char **argv)
{
    ...
    do
    {
        printf("\n\nDigite o numero da secao que deseja executar (1:12) ou 0 para sair: ");
        scanf("%d", &nExercicio);
        printf("\n\n\n");
